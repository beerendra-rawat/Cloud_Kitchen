...
class recentOrderItems : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recentOrderItems ?.let { orderDetails ->
            if(orderDetails.isNotEmpty()){
                ...
                allFoodQuantities = recentOrderItems.foodQuantity as ArrayList<Int>
            }
        }
        setAdapter()
    }
    ...
    private fun setAdapter() {
        ...
        val adaptar = RecentBuyAdapter(this, allFoodNames, allFoodImages, allFoodPrices, allFoodQuantities)
        rv.adapter = adaptar
    }
}